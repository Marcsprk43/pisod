...
def draw_altitude(frame, mv):
    ...
    cv2.putText(frame, 'A:{:3d}'.format(int(mv.data['Altitude']*3.28)), (550, 25), font, 1, text_color, 2, cv2.LINE_AA)

def draw_lat_lon(frame, mv):
    cv2.putText(frame, 'Lat:{:02.6f}'.format(int(mv.data['Lat'])), (5, 25), font, 1, (0,255, 255), 2, cv2.LINE_AA)
    cv2.putText(frame, 'Lon:{:02.6f}'.format(int(mv.data['Lon'])), (270, 25), font, 1, (0,255, 255), 2, cv2.LINE_AA)
...
def draw_camera_capture(frame, image_number):
    cv2.putText(frame, 'Image Acquired: {}'.format(image_number), (100,100), font, 1, (255,255, 255), 2, cv2.LINE_AA)
...
def draw_capture_grid(frame, yaw,altitude):
    if (altitude >5):
        ...
        cv2.line(frame, (x1+360,-y1+288), (x2+360,-y2+288), (0,255, 255), 2)
        cv2.line(frame, (x2+360,-y2+288), (x3+360,-y3+288), (0,255, 255), 2)
        cv2.line(frame, (x3+360,-y3+288), (x4+360,-y4+288), (0,255, 255), 2)
        cv2.line(frame, (x4+360,-y4+288), (x1+360,-y1+288), (0,255, 255), 2)

        # draw lat-lon axes
        x1, y1 = rotate_vector(0, y, yaw)
        cv2.line(frame, (360-x1,288+y1), (x1+360,-y1+288), (255, 255, 255), 2)
        ...
        cv2.line(frame, (x1+360,-y1+288), (x2+360,-y2+288), (255, 255, 255), 2)
        cv2.line(frame, (x2+360,-y2+288), (-x1+360,y1+288), (255, 255, 255), 2)
        cv2.line(frame, (-x1+360,y1+288), (-x2+360,y2+288), (255, 255, 255), 2)
        cv2.line(frame, (-x2+360,y2+288), (x1+360,-y1+288), (255, 255, 255), 2)
